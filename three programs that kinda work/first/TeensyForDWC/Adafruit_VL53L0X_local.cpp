...
boolean Adafruit_VL53L0X_local::begin(uint8_t i2c_addr, boolean debug, i2c_pins pins) {
  //  int32_t   status_int;
  //  int32_t   init_done         = 0;
...
boolean Adafruit_VL53L0X_local::setAddress(uint8_t newAddr) {
  newAddr &= 0x7F;
...
VL53L0X_Error Adafruit_VL53L0X_local::getSingleRangingMeasurement( VL53L0X_RangingMeasurementData_t *RangingMeasurementData, boolean debug )
{
...
void Adafruit_VL53L0X_local::printRangeStatus( VL53L0X_RangingMeasurementData_t* pRangingMeasurementData )
{
